...
const blocks = [
  ...
  { kind: 'dl-evidence', id: 'forecast-a', claim: 'weather-claim', direction: 'support', weight: 0.9, verified: true, sequence: 1, label: 'Forecast A', source: null },
  { kind: 'dl-evidence', id: 'forecast-b', claim: 'weather-claim', direction: 'support', weight: 0.8, verified: true, sequence: 2, label: 'Forecast B', source: null },
  { kind: 'dl-evidence', id: 'front-shift', claim: 'weather-claim', direction: 'oppose', weight: 5, verified: true, sequence: 3, label: 'Front shift', source: null },
  { kind: 'dl-evidence', id: 'radar-update', claim: 'weather-claim', direction: 'oppose', weight: 5, verified: true, sequence: 4, label: 'Radar update', source: null },
  {
    kind: 'dl-judgment',
    id: 'weather-judge',
    claim: 'weather-claim',
